...
import { moveInOutRequirements } from '../data/moveInOutRequirements';
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-muted-foreground">Overall Condition Score:</span>
...
export default MoveInOutReport;
